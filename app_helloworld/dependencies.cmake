...
macro(sandbox_add CODEDOMAIN LOCATION TAG)
  ...
  set(CODEDOMAIN_CMAKE_FILE "${CODEDOMAIN_DIR}/${CODEDOMAIN}/${CODEDOMAIN}.cmake")
  if(EXISTS ${CODEDOMAIN_CMAKE_FILE})
   include(${CODEDOMAIN_CMAKE_FILE})
  endif()
...
sandbox_add(lib_logging                    git@github.com:keithm-xmos/lib_logging             2ba5aca2a4a42cb4c29e285e7a110bceb06bf553)
